        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
                <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center">
                    ...
                    <p className="text-gray-500 mb-8">This invitation link is no longer valid. Please ask your admin for a new one.</p>
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
                <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center">
                    ...
                    <p className="text-gray-500 mb-8">Invitations expire after 7 days for security. Please request a new invitation.</p>
                    <Link href="/" className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-xl transition duration-200">
                        Go Home
                    </Link>
                </div>
    ...
    if (session?.user) {
        if (session.user.email === invitation.email) {
            ...
            return (
                <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
                    <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center">
                        <h1 className="text-2xl font-bold text-gray-900 mb-4">Mismatched Account</h1>
                        <p className="text-gray-600 mb-8">
                        ...
                        <Link href="/api/auth/signout" className="inline-block bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-3 px-8 rounded-xl transition duration-200">
                            Log Out
                        </Link>
                    </div>
                </div>
            ...
            <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center">
                ...
                <div className="space-y-4">
                    ...
                    <Link
                        ...
                        className="block w-full bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-semibold py-3 px-8 rounded-xl transition duration-200"
                    >
                        Log In to Join
                    </Link>
                </div>
